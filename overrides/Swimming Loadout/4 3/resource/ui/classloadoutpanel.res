"Resource/UI/FullLoadoutPanel.res"
{
	...
	"TopBgImage"
	{
		...
		"tall"			"480"
		"image"			"replay/thumbnails/main_bg"
		"scaleImage"	"1"
		"enabled"		"1"
		"visible"		"1"
	}
...
//	}
	...
	"classmodelpanel"
	{
		...
		"model"
		{
			...
			{
				"name"		"PRIMARY"
				"activity"	"ACT_MP_SWIM_PRIMARY"
				"default"	"1"
			}
			"animation"
			{
				"name"		"SECONDARY"
				"activity"	"ACT_MP_SWIM_SECONDARY"
			}
			"animation"
			{
				"name"		"MELEE"
				"activity"	"ACT_MP_SWIM_MELEE"
			}
			"animation"
			{
				"name"		"BUILDING"
				"activity"	"ACT_MP_SWIM_BUILDING"
			}
			"animation"
			{
				"name"		"PDA"
				"activity"	"ACT_MP_SWIM_PDA"
			}
			"animation"
			{
				"name"		"ITEM1"
				"activity"	"ACT_MP_SWIM_ITEM1"
			}						
			"animation"
			{
				"name"		"ITEM2"
				"activity"	"ACT_MP_SWIM_ITEM2"
			}									
			"animation"
			{
				"name"		"MELEE_ALLCLASS"
				"activity"	"ACT_MP_SWIM_MELEE_ALLCLASS"
			}
			"animation"
			{
				"name"		"PRIMARY2"
			...
			{
				"name"		"SECONDARY2"
				"activity"	"ACT_MP_SWIM_SECONDARY2"
			}
		}
	}
